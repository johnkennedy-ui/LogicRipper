@{
    ...
    FunctionsToExport = @(
        ...
        'Remove-LogicRipperTemplate',
        'New-LogicRipperTargetWorkspace',
        'Save-LogicRipperTargetWorkspace',
        'Get-LogicRipperTargetWorkspace',
        'Remove-LogicRipperTargetWorkspace',
        'Copy-LogicRipperTargetWorkspace',
        'New-LogicRipperBinding',
        'Save-LogicRipperBinding',
        'Get-LogicRipperBinding',
        'Remove-LogicRipperBinding',
